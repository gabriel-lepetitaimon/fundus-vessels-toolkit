...
class VascularGraph:
    ...
    def jppype_layer(self, edge_labels=False, node_labels=False, edge_map=True):
        ...
        l = LayerGraph(self.node_adjacency_list(), self._nodes_yx_coord, self._branch_labels_map)
        l.set_options({'edge_labels_visible': edge_labels, 'node_labels_visible': node_labels, 'edge_map_visible': edge_map})
        return l
